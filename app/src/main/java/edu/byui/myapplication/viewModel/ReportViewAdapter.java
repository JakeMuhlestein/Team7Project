...
public class ReportViewAdapter extends RecyclerView.Adapter<ReportViewAdapter.ReportViewHolder> {
    ...
    /**
     * This sets up the interface for the listener which is generated by Jetpack's
     * Architecture Components. This allows for a level of abstraction which adhears to the
     * GroupOfFour's (Go4) code to the interface not the implementation.
     */
